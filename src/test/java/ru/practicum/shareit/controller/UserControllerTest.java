...
public class UserControllerTest {
    ...
    void setUp() {
        ...
        this.userDto.setEmail("mail@mail.ru");
    ...
    @Test
    public void createUserTestFailValidation() throws Exception {
        userDto.setEmail("bad mail");
        mvc.perform(post("/users")
                        .content(mapper.writeValueAsString(userDto))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void createUserTestFailWithEmptyName() throws Exception {
